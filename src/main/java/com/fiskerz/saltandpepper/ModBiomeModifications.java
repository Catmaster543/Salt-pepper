...
public final class ModBiomeModifications {
    ...
    public static void register() {
        ...
        Predicate<BiomeSelectionContext> coastal = BiomeSelectors.tag(ConventionalBiomeTags.IS_BEACH)
        ...
        BiomeModifications.addFeature(
                BiomeSelectors.tag(BiomeTags.IS_JUNGLE).or(BiomeSelectors.tag(ConventionalBiomeTags.IS_JUNGLE)),
